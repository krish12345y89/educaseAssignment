...
export default (db) => {
    ...
    router.post('/schools', validateAddSchool, handleValidationErrors, schoolController.addSchool);
    router.get('/schools', validateListSchools, handleValidationErrors, schoolController.listSchools);
